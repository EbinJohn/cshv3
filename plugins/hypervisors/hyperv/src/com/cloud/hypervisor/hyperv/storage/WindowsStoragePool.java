...
public class WindowsStoragePool implements HypervStoragePool {
    ...
    public WindowsStoragePool(String uuid, String name, StoragePoolType type,
    ...
    public PhysicalDiskFormat getDefaultFormat() {
    	// todo:  do we need to change to VHDX?
        return PhysicalDiskFormat.VHD;
    }

    @Override
    public HypervPhysicalDisk createPhysicalDisk(String name,
    ...
    @Override
    public HypervPhysicalDisk createPhysicalDisk(String name, long size) {
    ...
    @Override
    public List<HypervPhysicalDisk> listPhysicalDisks() {
